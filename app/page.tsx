...
export default function Home() {
  ...
  return (
    ...
    <div className="bg-background min-h-screen flex flex-col relative">
     ...
     <Hero/>
     <Služby theme={theme} isMenuOpen={isMenuOpen} setIsMenuOpen={setIsMenuOpen}/>
     <Pricing theme={theme} isMenuOpen={isMenuOpen} setIsMenuOpen={setIsMenuOpen}/>
     <Galerie theme={theme} isMenuOpen={isMenuOpen} setIsMenuOpen={setIsMenuOpen}/>
